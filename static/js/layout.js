$(function () {
  ...
  if (typeof Swiper != 'undefined') {
    ...
    var historyswiper = new Swiper('.historyulitem', {
      ...
      spaceBetween: 0,
      slidesPerGroup: 1,
      breakpoints: {991: {slidesPerView: 3,}, 414: {spaceBetween: 0, slidesPerView: 1}}
    });
    var inxnewswiper = new Swiper('.inxnews-list', {
      ...
      paginationClickable: true,
      breakpoints: {768: {slidesPerView: 3, spaceBetween: 20}, 414: {spaceBetween: 10, slidesPerView: 1}}
    });
    ...
    var inxsolutSwiper = new Swiper(".inxSolut-min", {
      ...
      breakpoints: {768: {slidesPerView: 3, spaceBetween: 20,}, 414: {slidesPerView: 1}}
    });
    var inxpartSwiper = new Swiper(".partner-wrapper", {
      ...
      breakpoints: {768: {slidesPerView: 3, spaceBetween: 20,}, 414: {spaceBetween: 10, slidesPerView: 2}}
    });
